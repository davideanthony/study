...
export const NOTE_LIST_COLUMNS =
  "id, user_id, title, course, university, description, academic_year, semester, faculty, file_path, file_name, thumbnail_path, download_count, like_count, created_at, version_number, profiles(username, full_name, avatar_url)";
